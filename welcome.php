...
<body>
    ...
    The survey should take about 5-10 minutes of your time. </br></br>
    	<button style = "cursor:pointer; ont-family: inherit; font-size: 14px" onclick="openPDF()">View Letter of Information and Consent</button>
	<script>
		function openPDF() {
    	// URL to the PDF file
	...
	<div class="form-control">
        <table>
            <tr><td colspan = "2"> <h3>Do you agree to taking part in the survey? </h3></td></tr>
            <tr><td><input type="submit" value="Yes" name="cont" ></input></td>
			<td><input type="submit" value="No" name ="ex" > </input></td></tr>                   
		</table>
	</div>
    </form>
</body>
